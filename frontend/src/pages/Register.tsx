      ...
      <main className="flex-1 bg-surface flex flex-col justify-center items-center px-6 lg:px-24">
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <button type="button" className="flex items-center justify-center gap-3 bg-surface-container-high py-3 rounded-lg hover:bg-surface-bright transition-all active:scale-95 group">
