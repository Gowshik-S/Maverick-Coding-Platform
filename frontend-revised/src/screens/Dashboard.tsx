    ...
    <div className="bg-background text-on-surface overflow-hidden flex h-screen">
      ...
      <aside className="fixed left-0 top-0 h-screen w-[200px] bg-[#202020] flex-col py-4 z-40 hidden md:flex">
        ...
        <nav className="flex-grow space-y-1">
          ...
          <a className="text-[#dac2b2] hover:bg-[#2a2d2e] flex items-center gap-3 px-4 py-3 font-['Inter'] text-xs font-bold uppercase tracking-widest transition-all duration-200 ease-in-out" href="#">
        ...
        <div className="mt-auto border-t border-outline-variant/10">
          ...
          <div className="px-4 py-4 flex items-center gap-3 border-b border-outline-variant/10">
            ...
            <div className="overflow-hidden">
              <p className="text-xs font-bold truncate">MavUser</p>
              <p className="text-[9px] text-on-surface-variant uppercase tracking-tighter">Pro Developer</p>
            </div>
          </div>
          <a className="text-[#dac2b2] hover:bg-[#2a2d2e] flex items-center gap-3 px-4 py-3 font-['Inter'] text-xs font-bold uppercase tracking-widest" href="#">
      ...
      <main className="ml-0 md:ml-[200px] h-screen overflow-y-auto custom-scrollbar p-6 flex-1">
        ...
        <header className="mb-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-black">Welcome, MavUser</h1>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-right border-r border-outline-variant/20 pr-6">
              <span className="text-primary font-black text-2xl">480</span>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="text-right hidden sm:block">
                  <p className="text-sm font-bold">MavUser</p>
            ...
            <div className="bg-surface-container-low rounded-lg border-t-4 border-primary-container overflow-hidden w-full flex flex-col">
              <div className="p-6 relative flex flex-col h-full">
                ...
                <div className="mt-auto">
                  <button onClick={() => onNavigate('assessment-ide')} className="w-full py-4 bg-secondary-container text-on-secondary font-black uppercase text-sm rounded hover:brightness-110 transition-all flex items-center justify-center gap-2">
                    Join Hackathon
            ...
            <div className="bg-surface-container-low rounded-lg p-6 w-full">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-separate border-spacing-y-2">
                  ...
                  <tbody>
                    <tr className="bg-surface-container hover:bg-surface-container-high transition-all cursor-pointer group">
                      ...
                      <td className="px-4 py-4 text-xs">Frontend Architecture</td>
                    ...
                    <tr className="bg-surface-container hover:bg-surface-container-high transition-all cursor-pointer group">
                      <td className="px-4 py-4 rounded-l-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-bold">SQL Deep Dive</span>
                        </div>
                      </td>
                      <td className="px-4 py-4 text-xs">Database</td>
                      <td className="px-4 py-4 text-right rounded-r-lg">
                        <span className="text-[10px] font-bold px-2 py-1 bg-primary-container/10 text-primary rounded">COMPLETED</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="lg:col-span-4 flex">
            <div className="bg-surface-container-low rounded-lg p-6 w-full">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 bg-primary-container/10 rounded border-l-4 border-primary-container">
                  <span className="text-lg font-black w-4 text-primary">14</span>
                  <div className="w-10 h-10 rounded bg-surface-container-high overflow-hidden">
                    <img alt="Current User" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBaNQo4HsViJosONnKZpK0Vm1hv5m2UxHfhvREk5I534kkAG3-Vgj8mwLMakeAzHScgxLZ_GKg3HuE3Q1jlWfz0gqoNwSEDCF49WO8j0d4RFUSA01A1NdaR0eGPAFJNRHbTNA8s_AzK7zncBCUuh-kLlKBvmAtw1-rgAuBnS7FwD1lksewiQx05GR__vlyEsAffhqNIWdTDlUE496n74AfXZjt_8g8om5laCOiCo3SEjv4WsXLUPgd2WXBRDJE_8EsPWRLwfuXZog" className="" />
                  </div>
                  <div className="flex-grow">
                    <p className="text-sm font-bold text-primary">You (MavUser)</p>
                    <p className="text-[10px] text-on-surface-variant">480 pts</p>
                  </div>
                  <span className="text-[10px] font-bold text-primary bg-primary-container/20 px-2 py-1 rounded">PRO</span>
                </div>
                <div className="flex items-center gap-4 p-3 bg-surface-container/30 rounded border-l-4 border-[#FFD700]">
                  <span className="text-lg font-black w-4">1</span>
                  <div className="w-10 h-10 rounded bg-surface-container-high overflow-hidden">
                    <img alt="Rank 1 Avatar" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAwido4FrOyQDl-Ivu-_zuj02_tAWsydu_3xRfz7MhShCvwB731oElIDT_1kELoCc6UBxTOb0gwof3RA2RO4pGvycoTM6hEinNJHXl8kOTjYjZGpud3OfKen9iNvQFe4hmfCAtzAc2GXF7BDOsFSf6t1dIMwJ5nLZlC0RPp1Nv2UhuBbmJXoVVavcrG-kCDyhLlIDWQcb4BQ9_lrNkpbrmvCYUrUIWewMp0dsTJjY22ivLJAmg2aeIoBOh5Pu-xPjgV2fozKCQlkA" className="" />
                  </div>
                  <div className="flex-grow">
                    <p className="text-sm font-bold">Dev_Maverick</p>
                    <p className="text-[10px] text-on-surface-variant">2,450 pts</p>
                  </div>
                </div>
              </div>
            </div>
