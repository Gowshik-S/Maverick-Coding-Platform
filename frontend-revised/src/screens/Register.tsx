...
export default function Register({ onNavigate }: { onNavigate: (s: Screen) => void }) {
  return (
      ...
      <div className="w-full max-w-5xl flex flex-col md:flex-row bg-surface-container-low border border-outline-variant/30 maverick-shadow overflow-hidden">
        ...
        <div className="w-full md:w-2/3 p-10 md:p-16 flex flex-col justify-center">
          <div className="max-w-md w-full mx-auto">
            ...
            <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); onNavigate('profile-builder'); }}>
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label htmlFor="firstName" className="text-[10px] font-bold text-outline uppercase tracking-widest">First Name</label>
                  <input type="text" id="firstName" className="w-full bg-surface-container-highest border border-outline-variant/50 text-white text-sm focus:ring-1 focus:ring-primary focus:border-primary block p-3 transition-colors" placeholder="Jane" required />
                </div>
                <div className="space-y-1">
                  <label htmlFor="lastName" className="text-[10px] font-bold text-outline uppercase tracking-widest">Last Name</label>
                  <input type="text" id="lastName" className="w-full bg-surface-container-highest border border-outline-variant/50 text-white text-sm focus:ring-1 focus:ring-primary focus:border-primary block p-3 transition-colors" placeholder="Doe" required />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input type="email" id="email" className="w-full bg-surface-container-highest border border-outline-variant/50 text-white text-sm focus:ring-1 focus:ring-primary focus:border-primary block pl-10 p-3 transition-colors" placeholder="jane.doe@example.com" required />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input type="password" id="password" className="w-full bg-surface-container-highest border border-outline-variant/50 text-white text-sm focus:ring-1 focus:ring-primary focus:border-primary block pl-10 p-3 transition-colors" placeholder="••••••••" required />
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 w-full bg-surface-container-highest border border-outline-variant/30 hover:bg-surface-container-high text-white font-bold text-sm py-3 px-4 transition-colors">
