...
export default function ProfileBuilder({ onNavigate }: { onNavigate: (s: Screen) => void }) {
  return (
        ...
        <div className="w-full md:w-2/4 p-10 flex flex-col">
          ...
          <div className="flex-1 flex flex-col justify-center">
            <div className="relative group cursor-pointer">
              ...
              <input type="file" className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" accept=".pdf,.doc,.docx,.txt" />
            </div>
          ...
          <div className="mt-8 flex justify-end">
            <button onClick={() => onNavigate('extraction-analysis')} className="kinetic-monolith-gradient text-on-primary font-black tracking-widest uppercase text-sm py-4 px-8 transition-all hover:brightness-110 active:scale-[0.98] flex items-center gap-2">
              UPLOAD &amp; ANALYZE
