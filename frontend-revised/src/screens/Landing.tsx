        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-12">
            <div className="flex flex-col gap-3">
              ...
              <a className="text-zinc-500 hover:text-primary transition-colors text-sm" href="#">Assessments</a>
              <a className="text-zinc-500 hover:text-primary transition-colors text-sm" href="#">Learning Path</a>
              <a className="text-zinc-500 hover:text-primary transition-colors text-sm" href="#">Hackathons</a>
            </div>
            <div className="flex flex-col gap-3">
              <span className="text-white font-bold text-xs uppercase tracking-widest mb-2">Company</span>
              <a className="text-zinc-500 hover:text-primary transition-colors text-sm" href="#">About</a>
              <a className="text-zinc-500 hover:text-primary transition-colors text-sm" href="#">Editorial</a>
              <a className="text-zinc-500 hover:text-primary transition-colors text-sm" href="#">Privacy</a>
            </div>
            <div className="flex flex-col gap-3">
              <span className="text-white font-bold text-xs uppercase tracking-widest mb-2">Social</span>
              <a className="text-zinc-500 hover:text-primary transition-colors text-sm" href="#">Twitter</a>
              <a className="text-zinc-500 hover:text-primary transition-colors text-sm" href="#">GitHub</a>
              <a className="text-zinc-500 hover:text-primary transition-colors text-sm" href="#">Discord</a>
            </div>
          </div>
        </div>
